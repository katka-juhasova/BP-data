...
function plugin:access(plugin_conf)
  ...
  local orig = ngx.req.get_headers()['Host']

  local clean = orig:gsub( plugin_conf["replace_environment"], plugin_conf["target_environment"])

  ngx.req.set_header("Host", clean)
  ngx.req.set_header("X-Host-Original", orig)
  ngx.var.upstream_host = clean
