...
**This is a hard fork of the [nokia/kong-oidc](https://github.com/nokia/kong-oidc) plugin since that project has been abandoned.**

**Continuous Integration:** [![Build Status](https://travis-ci.org/lorenzoaiello/kong-oidc.svg?branch=master)](https://travis-ci.org/lorenzoaiello/kong-oidc) 
[![Coverage Status](https://coveralls.io/repos/github/lorenzoaiello/kong-oidc/badge.svg?branch=master)](https://coveralls.io/github/lorenzoaiello/kong-oidc?branch=master) <br/>
