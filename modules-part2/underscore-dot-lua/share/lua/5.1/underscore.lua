...
-- the use of iterators or lists with holes is therefore discouraged, a very useful side-effect of
...
Underscore.funcs.shuffle = (function ()
  return function (list)
    ...
    local func = function () Underscore.funcs.push (acc, Underscore.funcs.grab(list, math.random (#list))) end
    Underscore.funcs.safe_each (list, func)
    return acc
  end
end)()
