...
local attribute_remover = require "kong.plugins.file-log-exclusion.attribute-remover"
...
local FileLogExclusionHandler = BasePlugin:extend()

FileLogExclusionHandler.PRIORITY = 1

function FileLogExclusionHandler:new()
  FileLogExclusionHandler.super.new(self, "file-log-exclusion")
end

function FileLogExclusionHandler:log(conf)
  FileLogExclusionHandler.super.log(self)
...
return FileLogExclusionHandler
